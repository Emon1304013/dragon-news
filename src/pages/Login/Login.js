...
const Login = () => {
  ...
  const { userLogin,googleSignIn,resetPass,setLoading } = useContext(AuthContext);
        ...
        >
          <div className='space-y-4'>
            ...
            <div>
              ...
              />
              <span className='absolute right-4 cursor-pointer' onClick={handleShowPass}><FaEye></FaEye></span>
              </div>
